...
import { PRODUCT_AVAILABILITY, AVAILABILITY_TONE, AVAILABILITY_LABEL } from '@/lib/product-status';
          ...
          {Object.values(PRODUCTS).map((p) => (
            <Card key={p.code}>
              <div className="wtc-spread" style={{ alignItems: 'flex-start', gap: 8 }}>
                ...
                <StatusPill tone={AVAILABILITY_TONE[PRODUCT_AVAILABILITY[p.code].status]}>{AVAILABILITY_LABEL[PRODUCT_AVAILABILITY[p.code].status]}</StatusPill>
              </div>
